...
\begin{frame}
  ...
  {\color{themecolor}{\textbf{Definition}}}\\
...
% {\pictureslide{03b-functions-examples/03b-functions-examples-001.jpeg}}
% {\pictureslide{03b-functions-examples/03b-functions-examples-002.jpeg}}
...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \hfill \mygray{[every $y$ is covered by some \textit{unique} $x$]}
