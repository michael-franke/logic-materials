...
\begin{frame}
  ...
  \begin{itemize}
    \item four different slots: \hfill \mycom{tutorials start after the next lecture}
    \begin{enumerate}
      \item \makebox[11.5em][l]{Aida Rostami: }          Monday 14:00
      \item \makebox[11.5em][l]{Seoha Lee:  }            Thursday 12:00
      \item \makebox[11.5em][l]{Xueqing Wei: }           Thursday 16:00
      \item \makebox[11.5em][l]{Shanshan Xu: }           Friday 12:00
    \end{enumerate}
...
\begin{frame}
  \frametitle{Exam}
  \begin{itemize}
    \item February 3 2026, 14:00-16:00 (CET)
