...
In the natural deduction system to be introduced below, dropping the controversial derivation rules \EFSQ and $\neg \neg$E gives a system called \emph{minimal logic}.
Adding just \EFSQ but not $\neg \neg$E gives \emph{intuitionistic logic}.
...
$\begin{nd}
  ...
  \have  {3}  {q \lor p}  \oi{2}
  \close
  \have  {4}  {p \rightarrow (q \lor p)}  \ii{}
  \open
  \hypo  {5}  {q}         \add{}
  \have  {6}  {q \lor p}  \oi{5}
  \close
  \have  {7}  {q \rightarrow (q \lor p)}  \ii{}
  \have  {8}  {q \lor p}  \oe{1, 4, 7}
\end{nd}$
